  ...
  return (
    <div className="text-center p-8">
      ...
      <div className="flex justify-center items-center gap-6 flex-wrap">
        ...
        <Link
          to="/scramble"
          className="group flex flex-col items-center justify-center w-64 h-48 bg-white border border-[var(--border-color)] rounded-xl shadow-lg p-6 text-center cursor-pointer transform transition-all duration-300 hover:scale-[1.05] hover:shadow-2xl hover:bg-orange-50"
        >
          <span className="text-5xl mb-4 group-hover:scale-110 transition-transform duration-300">🔄</span>
          <h2 className="text-xl font-semibold text-[var(--text-dark)] group-hover:text-orange-600">
            Play Scramble
          </h2>
